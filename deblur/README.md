...
01 - Baixar imagens e adicionar na pasta dataset/deblurring
02 - Executar o test_gopro_hide.py
03 - Verificar resultados
04 - Testar outros datasets
05 - Preparar uma função para receber uma imagem e devolver a versão desborrada