...
def teste_gopro_hide_r(imagePath=None):
    parser = argparse.ArgumentParser(description='Image motion deblurring evaluation on GoPro/HIDE')
    parser.add_argument('--input_dir', default='C:\\Users\\Danilo\\code\\Uformer-main\\dataset\\deblurring',
    ...
    with torch.no_grad():
        ...
        for ii, data_test in enumerate(tqdm(test_loader), 0):
            ...
            ssim = ssim_loss(rgb_restored, rgb_gt, multichannel=True, channel_axis=2)
